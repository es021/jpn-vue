...
// this only for urusniaga-utama childrens
...
$(document).ready(function () {
    ...
    $.get("navigation.json", function (res) {
        ...
        body.append("<h3>NAVIGATION MAP</h3>");
        appendDataToBody(JSON.stringify(getMapNavi(ROOT)));
